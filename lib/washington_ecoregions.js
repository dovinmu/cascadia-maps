...
(function() {
  var changeText, getClassName, height, initMap, loadJson, onClick, path, processTree, projection, region_trees, removeImages, selected, selectedText, selectedTextDetail, showImage, svg, width;
  ...
  showImage = function(name, i) {
    ...
    return svg.append("svg:image").attr("xlink:href", "images/" + fname).attr("x", x).attr("y", y).attr("width", 150).attr("height", 300);
  };
