...
(function() {
  ...
  initMap = function(error, ecotopo) {
    ...
    ref1 = ["A tree is beautiful, but what’s more, it has a right ", "to life; like water, the sun and the stars, it is ", "essential. Life on earth is inconceivable without trees.", " - Anton Chekov"];
  ...
  positionText = function() {
    ...
    mapDescription.attr('x', coords[0]).attr('y', coords[1]).style('font-size', tinymode ? '12px' : '13px');
    if (portrait) {
      treeMenuLat = 45.33;
      treeMenuLon = -124.7;
    } else {
